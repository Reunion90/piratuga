<?php 
    ...
    mysqli_query($connection, "INSERT INTO movies (title, translated, synopsis, server1, server2, server3, poster, banner, stars, id, date_year) VALUES ('".$title."' , '".$_POST['translated']."' , '".$plot."' , '".$sv1."' , '".$_POST['sv2']."' , '".$_POST['sv3']."' , '".$movie['Poster']."' , '".$banner_file."' , '".round($movie['imdbRating']/2)."' , '".$_POST['id']."' , '".$movie['Year']."' )") or die(mysqli_error($connection));
    header("location:../admin/admin.php?msg=Sucesso!&p=add_movie_server");
?>