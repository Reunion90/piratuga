<?php 
    ...
    mysqli_query($connection, "INSERT INTO tv_shows (title, translated, synopsis, poster, banner, stars, id, date_year) VALUES ('".$title."' , '".$_POST['translated']."' , '".$plot."', '".$movie['Poster']."' , '".$banner_file."' , '".round($movie['imdbRating']/2)."', '".$_POST['id']."' , '".$movie['Year']."' )") or die(mysqli_error($connection));
